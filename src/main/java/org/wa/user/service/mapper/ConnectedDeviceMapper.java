...
public interface ConnectedDeviceMapper {
    ConnectedDeviceResponseDto toResponseDto(ConnectedDevice device);

    List<ConnectedDeviceResponseDto> toResponseDtoList(List<ConnectedDevice> devices);

    @Mapping(target = "id", ignore = true)
    @Mapping(target = "user", ignore = true)
    @Mapping(target = "isActive", ignore = true)
    @Mapping(target = "lastSyncAt", ignore = true)
    ConnectedDevice toEntity(ConnectedDeviceCreateDto createDto);
    ...
    @Mapping(target = "lastSyncAt", ignore = true)
    void updateEntityFromDto(ConnectedDeviceUpdateDto updateDto, @MappingTarget ConnectedDevice device);
